...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ProductSearchMissingLocationException.class)
    public ResponseEntity<String> handleMissingLocationException(ProductSearchMissingLocationException ex) {
